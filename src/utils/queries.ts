...
export const movieQueries={
  GET_MOVIE:`SELECT * FROM pelicula_serie where id_pelicula_serie like $1 `,
  ...
  GET_COMMENT:`SELECT * FROM comentario WHERE id_pelicula_serie=$1`,
  INSERT_COMMENT:`INSERT INTO comentario (id_pelicula_serie, alias, contenido, puntuacion) values ($1,(SELECT alias FROM usuario where correo like $2),$3,$4) RETURNING *`
};
